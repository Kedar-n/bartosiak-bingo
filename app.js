...
function generate() {
  button.addEventListener('click', () => {
    ...
    `Odbyłem niedawno konferencję z ludźmi z najwyższego szczebla decyzyjnego Pentagonu. Oni mają pełną świadomość, co to ${pickArray[0]} i ja im naprawdę nie muszę tego tłumaczyć. Za to oni pytają mnie: dlaczego w Polsce nie ma dyskusji na tematy, takie jak ${pickArray[1]} czy ${pickArray[2]}? I przyjdzie niedługo moment, że będziemy musieli usiąść z nimi do stolika i renegocjować naszą pozycję w regionie, którą dziś wyznacza konkretne value np. ${pickArray[3]}. Jeśli my teraz tego nie nadgonimy, pogrążeni w jałowym sporze o definicję ${pickArray[4]}, to możemy mieć zaraz powtórkę z września 39. `
  ];
